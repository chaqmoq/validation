...
public enum ConstraintType {
    ...
    public var constraint: Constraint {
        ...
        case let .hexColor(message, groups): return HexColorConstraint(message, groups: groups)
        ...
        case let .phoneNumber(message, groups): return PhoneNumberConstraint(message, groups: groups)
        case let .regex(pattern, message, groups): return RegexConstraint(pattern, message: message, groups: groups)
        case let .url(message, isFileURL, groups): return URLConstraint(message, isFileURL: isFileURL, groups: groups)
